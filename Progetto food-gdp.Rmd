...
```{r}
#usare R quadro invece che aic che penalizzerà sempre gam perchè ha più parametri di arima e arimax a parte per india che usa solo other
R2 = rsquare(g4, data = itpop)
